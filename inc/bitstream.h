...
// ***************************************************************************
typedef struct MTC265_t MTC265_t;

typedef struct MTC265_BitStream 
{
    UInt8      *pucBits;
    UInt32      dwCache;
    Int         nCachedBits;
...
// ***************************************************************************
static void xBitStreamInit(MTC265_BitStream *pBS, UInt8 *pucBuffer, Int nBufferSize)
{
...
static void xPutBits32(MTC265_BitStream *pBS, UInt32 uiBits)
{
...
static void xPutBits(MTC265_BitStream *pBS, UInt32 uiBits, Int nNumBits)
{
...
static void xWriteAlignZero(MTC265_BitStream *pBS)
{
    Int nShift = (8 - pBS->nCachedBits) & 7;
    xPutBits(pBS, 0, nShift);
}

static void xWriteAlignOne(MTC265_BitStream *pBS)
{
    Int nShift = (8 - pBS->nCachedBits) & 7;
    xPutBits(pBS, (1<<nShift)-1, nShift);
}

static void xWriteRBSPTrailingBits(MTC265_BitStream *pBS)
{
    xPutBits(pBS, 1, 1);
    xWriteAlignZero(pBS);
}

static Int32 xBitFlush(MTC265_BitStream *pBS)
{
...
// ***************************************************************************
static void xWriteCode( MTC265_BitStream *pBS, UInt32 uiCode, UInt32 uiLength )
{
    assert ( uiLength > 0 );
    xPutBits( pBS, uiCode, uiLength );
}

static void xWriteUvlc( MTC265_BitStream *pBS, UInt32 uiCode )
{
...
static void xWriteSvlc( MTC265_BitStream *pBS, Int32 iCode )
{
    UInt uiCode;
...
static void xWriteFlag( MTC265_BitStream *pBS, UInt32 uiCode )
{
