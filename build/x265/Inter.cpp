...
void xEncInterCheckRDCost(X265_t *h, X265_PartSize ePartSize, UInt8 uiDepth, UInt32 uiCUX, UInt32 uiCUY, double& totalPUbestSAD, Int32* PURelIdxForCompare)
{
...
void xEncInterDistortion(X265_t* h, X265_PartSize ePartSize, UInt8 uiDepth, UInt32 uiCUX, UInt32 uiCUY, UInt32& totalCoeffNxNBinEst, double& InterDistortion)
{
...
void xEncGetPUPosition( X265_t* h, X265_PartSize ePartSize, UInt8 uiDepth, Int32 PUpartIdx, UInt32* uisubPUX, UInt32* uisubPUY)
{  
	X265_Cache *pCache = &h->cache;
	if(ePartSize == SIZE_2Nx2N)
	{
...
void estInterPredQTChroma( X265_t *h, UInt32 nCUSize, UInt8 uiDepth, Int32 PURelIdx, UInt32 subCUX, UInt32 subCUY)
{
	X265_Cache *pCache = &h->cache;
	Int nQP = h->iQP;
...
void estInterPredQTWithCoeffBin( X265_t *h, UInt32 nCUSize, UInt8 uiDepth, Int32 PURelIdx, UInt32 subCUX, UInt32 subCUY, UInt32& CoeffNxNBinEst)
{
...
void estInterPredQTChromaWithCoeffBin( X265_t *h, UInt32 nCUSize, UInt8 uiDepth, Int32 PURelIdx, UInt32 subCUX, UInt32 subCUY, UInt32& CoeffNxNBinEstChroma)
{
	X265_Cache *pCache = &h->cache;
	Int nQP = h->iQP;
	Int nQPC = g_aucChromaScale[nQP];
...
void estInterPredQTLumaWithCoeffBin( X265_t *h, UInt32 nCUSize, UInt8 uiDepth, Int32 PURelIdx, UInt32 subCUX, UInt32 subCUY, UInt32& CoeffNxNBinEst)
{
	X265_Cache *pCache = &h->cache;
	Int nQP = h->iQP;
	UInt32 uiSumY;
...
void estInterPredQTLuma( X265_t *h, UInt32 nCUSize, UInt8 uiDepth, Int32 PURelIdx, UInt32 subCUX, UInt32 subCUY)
{
	X265_Cache *pCache = &h->cache;
	Int nQP = h->iQP;
	UInt32 uiSumY;
...
void estInterPredQT( X265_t *h, UInt32 nCUSize, UInt8 uiDepth, Int32 PURelIdx, UInt32 subCUX, UInt32 subCUY)
{
	X265_Cache* pCache = &h->cache;
...
void InterPrediction(X265_t *h, Interpara * StartInter, X265_PartSize ePartSize, UInt8 uiDepth, UInt32 subPUX, UInt32 subPUY, double& PUBestSAD)
{
	//初始化
	X265_Cache* pCache = &h->cache;
...
void xTZ2PointSearch(X265_t *h, Interpara* StartInter, UInt8 uiDepth, X265_PartSize ePartSize)
{
...
void xPatternSearchFracDIF(X265_t *h, X265_PartSize ePartSize, UInt8 uiDepth, Int32 iCopyStart_x, Int32 iCopyStart_y, MVpara* pcMvInt, MVpara& rcMvHalf, MVpara& rcMvQter, double& ruiCost)
{
...
void xExtDIFUpSamplingH(X265_t *h, X265_PartSize ePartSize, UInt8 uiDepth, Int32 iCopyStart_x, Int32 iCopyStart_y)
{
	X265_Cache* pCache = &h->cache;
...
void xExtDIFUpSamplingQ(X265_t *h, X265_PartSize ePartSize, UInt8 uiDepth, Int32 iCopyStart_x, Int32 iCopyStart_y, MVpara halfPelRef )
{
	X265_Cache* pCache = &h->cache;
	UInt32 subPUX = pCache->subPUX;
	UInt32 subPUY = pCache->subPUY;
...
double xPatternRefinement( X265_t *h, UInt8 uiDepth, X265_PartSize ePartSize, MVpara baseRefMv, Int iFrac, MVpara& rcMvFrac )
{
	X265_Cache* pCache = &h->cache;
	double uiDist;
...
void xCheckBestMVP( X265_t *h, Interpara * StartInter, UInt MVPidxNum)
{
	X265_Cache* pCache = &h->cache;
	UInt32 subPUX = pCache->subPUX;
	UInt32 subPUY = pCache->subPUY;
...
void deriveLeftTopIdxGeneral( X265_t *h, UInt uiLCUIdx, UInt uiCUIdx, UInt uiDepth, X265_PartSize eCUMode, UInt uiPUIdx, UInt &ruiPartIdxLT )
{
...
void deriveRightTopIdxGeneral( X265_t *h, UInt uiLCUIdx, UInt uiCUIdx, UInt uiDepth, X265_PartSize eCUMode, UInt uiPUIdx, UInt &ruiPartIdxRT )
{
	UInt uiHorOffset, uiVerOffset;
	switch( eCUMode )
	{
...
void deriveLeftBottomIdxGeneral( X265_t *h, UInt uiLCUIdx, UInt uiCUIdx, UInt uiDepth, X265_PartSize eCUMode, UInt uiPUIdx, UInt &ruiPartIdxLB )
{
	UInt uiHorOffset, uiVerOffset;
	switch( eCUMode )
	{
...
void deriveCenterIdxGeneral(X265_t *h, UInt uiPUIdx, UInt uiDepth, X265_PartSize eCUMode, UInt &ruiPartIdxCenter)
{
...
void deriveRightBottomIdxGeneral( X265_t *h, UInt uiLCUIdx, UInt uiCUIdx, UInt uiDepth, X265_PartSize eCUMode, UInt uiPUIdx, UInt &ruiPartIdxRB )
{
	UInt uiHorOffset, uiVerOffset;
	switch( eCUMode )
	{
...
bool getPULeft( X265_t *h, UInt uiCurLCUIdx, UInt uiCurPartIdx, UInt &ruiLeftLCUIdx, UInt &ruiLeftPartIdx )
{
...
bool getPUAbove( X265_t *h, UInt uiCurLCUIdx, UInt uiCurPartIdx, UInt &ruiAboveLCUIdx, UInt &ruiAbovePartIdx )
{
	UInt uiNumPartInLCUWidth, uiNumLCUInPicWidth, uiCurPartRasterIdx;
	uiNumPartInLCUWidth = 1 << h->ucMaxCUDepth;
	uiNumLCUInPicWidth = ( h->usWidth + h->ucMaxCUWidth - 1 ) / h->ucMaxCUWidth;
...
bool getPUAboveLeft( X265_t *h, UInt uiCurLCUIdx, UInt uiCurPartIdx, UInt &ruiAboveLeftLCUIdx, UInt &ruiAboveLeftPartIdx )
{
	UInt uiNumPartInLCUWidth, uiNumLCUInPicWidth, uiCurPartRasterIdx;
...
bool getPUAboveRight( X265_t *h, UInt uiCurLCUIdx, UInt uiCurPartIdx, UInt &ruiAboveRightLCUIdx, UInt &ruiAboveRightPartIdx )
{
	UInt uiNumPartInLCUWidth, uiNumLCUInPicWidth, uiCurPartRasterIdx;
	Int uiHorOffset, uiVerOffset;
...
bool getPUBelowLeft( X265_t *h, UInt uiCurLCUIdx, UInt uiCurPartIdx, UInt &ruiBelowLeftLCUIdx, UInt &ruiBelowLeftPartIdx )
{
...
bool getPUBelowRight( X265_t *h, UInt uiCurLCUIdx, UInt uiCurPartIdx, UInt &ruiBelowRightLCUIdx, UInt &ruiBelowRightPartIdx )
{
	UInt uiNumPartInLCUWidth, uiNumLCUInPicWidth, uiNumLCUInPicHeight, uiCurPartRasterIdx;
	Int uiHorOffset, uiVerOffset;
...
void FindMv( X265_t *h, FindMv_Mode eFindMv, Int iRefidx, UInt8 uiDepth, UInt uiCurLCUIdx, UInt uiMvpLCUIdx, UInt uiMvpPURelIdx, UInt uiCurPURelIdx, X265_PartSize ePartSize, FindMv_Position MvPosition, Int32 PUPartIdx, MVpara& iMv, MVpara& iMvd )//前n参考帧，赋值为-n
{
	X265_Cache* pCache = &h->cache;
...
void PrevChangeMv( X265_t *h, MVpara * PrevFrameBestMv, MVpara * CurFrameBestMv)
{
	Int32 subPUHeight = 0;
	Int32 subPUWidth = 0;
	Int32 copyPURelIdx = 0;
...
void InterSearch( X265_t *h, Interpara* StartIn, UInt8 uiDepth, X265_PartSize ePartSize, Int32 iDist, Int32* SrchWindowRange )
{
...
Int8 xDiamondSearch ( X265_t *h, Interpara *StartIn, UInt8 uiDepth, X265_PartSize ePartSize, Int32 iCenX, Int32 iCenY, bool t )
{
	X265_Cache* pCache = &h->cache;
	UInt32 nCUSize = h->ucMaxCUWidth >> uiDepth;
	if ( t == 1 )
...
void DiamondSearch ( X265_t *h, Interpara * StartIn, UInt8 uiDepth, X265_PartSize ePartSize, Int32 iCenX, Int32 iCenY, Int32 iDist, Int32* SrchWindowSize, bool *t )
{
	X265_Cache  *pCache     = &h->cache;
...
double CalInterDistortion(Pxl * pSrc, Pxl * pPred, Int32 strideSrc, Int32 stridePred, UInt32 CUSize, X265_PartSize ePartSize)
{
	double dist=0;
	if (ePartSize == SIZE_2Nx2N)
	{
...
void MvpComparison ( X265_t *h, Interpara *StartIn, X265_PartSize ePartSize, UInt32 nCUSize, UInt32 subPUX, UInt32 subPUY)
{
	X265_Cache* pCache = &h->cache;
...
void xEncInterCompressCU(X265_t* h, UInt8 uiDepth, UInt32 uiCUX, UInt32 uiCUY, double &SAD_BestCU)
{
	X265_Cache* CU_Cache = &h->cache;
...
void xCheckRDCostMerge(X265_t *h, X265_PartSize ePartSize, UInt8 uiDepth, UInt32 uiCUX, UInt32 uiCUY, double SAD_ME, double& MEandMergeBestSAD,	Int32& tempBinNumberCost)
{
	X265_Cache* pCache = &h->cache;
	UInt32 nCUSize = h->ucMaxCUWidth >> uiDepth;
	Int32 subPUWidth = 0;
...
void xCheckRDCostMerge2Nx2N(X265_t *h, UInt8 uiDepth, UInt32 uiCUX, UInt32 uiCUY, double SAD_2Nx2N, double &SAD_BestCU, Int32& EarlySkipDetection)
{
	X265_Cache* CU_Cache = &h->cache;
	UInt32 nCUSize = h->ucMaxCUWidth>>uiDepth;
	Int32* CUrelIdx = CU_Cache->RelativeIdx;
	...
	Int32* PURelIdx = CU_Cache->PURelativeIdx;
	PURelIdx[uiDepth] = CUrelIdx[uiDepth];
	X265_PartSize ePartSize = SIZE_2Nx2N; 
	CU_Cache->subPUX = uiCUX;
	CU_Cache->subPUY = uiCUY;
	CU_Cache->cuX = uiCUX;
	CU_Cache->cuY = uiCUY;
...
void getInterMergeCandidates( X265_t *h, UInt uiLCUIdx, UInt CURelIdx, UInt uiDepth, X265_PartSize ePartSize, UInt PURelIdx, MVpara *MergeCandidatesMv, MVpara *MergeCandidatesMvd, UInt& numValidMergeCand )
{
	X265_Cache* pCache = &h->cache;
...
void getPartPosition( X265_t *h, UInt uiLCUIdx, UInt uiAbsCUIdx, UInt uiDepth, X265_PartSize eCUMode, UInt partIdx, Int& xP, Int& yP, Int& nPSW, Int& nPSH )
{
...
void setInterDepth(X265_t *h, UInt8 uiDepth )
{
	X265_Cache* pCache = &h->cache;
	UInt32 nCUSize = h->ucMaxCUWidth>>uiDepth;
	Int32* CURelIdx = pCache->RelativeIdx;
...
void CheckCUBestMode(X265_t *h, UInt8 uiDepth, double SAD_TotalCU, double& SAD_BestCU)//其中SAD_TotalCU为uiDepth+1的SAD之和,SAD_BestCU为当前uiDepth的SAD
{
	X265_Cache* pCache = &h->cache;
...
void copyRecCoefCbfUp(X265_t *h, Int32 nCUSize, UInt8 uiDepth, UInt32 uiCUX, UInt32 uiCUY)
{
	X265_Cache* pCache = &h->cache;
...
void CheckPUBestMode(X265_t *h, UInt8 uiDepth, Int32* PURelIdxCompare_SIZE_2Nx2N, Int32* PURelIdxCompare_SIZE_2NxN, Int32* PURelIdxCompare_SIZE_Nx2N, double SAD_2Nx2N, double SAD_2NxN, double SAD_Nx2N, double& SAD_BestPU)
{
	X265_Cache* pCache = &h->cache;
	X265_PartSize BestPartSize;
	UInt32 uiLCUIdx = h->uiCUX/h->ucMaxCUWidth + (((h->usWidth+h->PAD_YSIZEw)/h->ucMaxCUWidth) * (h->uiCUY/h->ucMaxCUWidth));
	Int32 TempInterToCur = 0;
	Int32 PURelIdx = 0;
	Int32 copyPURelIdx = 0;
...
void MotionCompensation( X265_t *h, MVpara MvY, Int32 iCopyStart_x, Int32 iCopyStart_y, UInt8 uiDepth, X265_PartSize ePartSize, Int32 PUpartindex, UInt32 subPUWidth, UInt32 subPUHeight)
{
	X265_Cache* pCache = &h->cache;
	UInt32 subPUX = 0;
	UInt32 subPUY = 0;
...
void xPredInterLumaBlk(X265_t *h, UInt8 uiDepth, MVpara MvY, Int32 iCopyStart_x, Int32 iCopyStart_y, UInt32 subPUWidth, UInt32 subPUHeight)
{
	X265_Cache* pCache = &h->cache;
...
void xPredInterChromaBlk(X265_t *h, UInt8 uiDepth, MVpara MvY, Int32 iCopyStart_x, Int32 iCopyStart_y, UInt32 subPUWidth, UInt32 subPUHeight)
{
	X265_Cache* pCache = &h->cache;
